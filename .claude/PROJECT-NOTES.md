...
The NIP paragraph also prints a REGON line (new field; empty hides it), on the same
bound paragraph, so no page content changed. NIP stays exactly as typed - a
digits-only copy in brackets was tried and rejected on 2026-09-23.
