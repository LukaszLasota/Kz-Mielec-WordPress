...
module.exports = {
	...
	entry: {
		...
		'glide-package/index': path.resolve(
			process.cwd(),
			...
			patterns: [
				{
					from: path.resolve(
						__dirname,
						'src/blocks/map-block/images'
					),
					to: path.resolve(
						__dirname,
						'build/blocks/map-block/images'
					),
				},
				{
					from: path.resolve(
						__dirname,
						'src/blocks/scroll-arrow/images'
					),
					to: path.resolve(
						__dirname,
						'build/blocks/scroll-arrow/images'
					),
				},
				{
					from: path.resolve(
